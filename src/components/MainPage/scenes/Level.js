...
export default class Level extends Phaser.Scene {
	...
	editorCreate() {
		...
		// wargames_Assets_
		const wargames_Assets_ = this.add.image(495, 480, "Wargames Assets ");
		wargames_Assets_.scaleX = 0.1;
		wargames_Assets_.scaleY = 0.1;
		...
		// wargames_Assets
		const wargames_Assets = this.add.image(839, 207, "Wargames Assets ");
		wargames_Assets.scaleX = 0.1;
		wargames_Assets.scaleY = 0.1;

		// wargames_Assets_1
		const wargames_Assets_1 = this.add.image(790, -287, "Wargames Assets ");
		wargames_Assets_1.scaleX = 0.1;
		wargames_Assets_1.scaleY = 0.1;

		// wargames_Assets_2
		const wargames_Assets_2 = this.add.image(785, -286, "Wargames Assets ");
		wargames_Assets_2.scaleX = 0.1;
		wargames_Assets_2.scaleY = 0.1;
		wargames_Assets_2.flipX = true;
