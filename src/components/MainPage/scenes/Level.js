...
export default class Level extends Phaser.Scene {
  ...
  editorCreate() {
    ...
    const patch_grass_foliageleft = this.add.image(
      149,
      515,
      "patch-grass-foliageleft",
    );
    patch_grass_foliageleft.scaleX = 0.5;
    patch_grass_foliageleft.scaleY = 0.5;

    // patch_grass_foliageright
    const patch_grass_foliageright = this.add.image(
      284,
      523,
      "patch-grass-foliageright",
    );
    ...
    const cargo_container_a_right = this.add.image(
      292,
      512,
      "cargo-container-a-right",
    );
    ...
    const structure_platformright = this.add.image(
      425,
      -671,
      "structure-platformright",
    );
    ...
    const structure_platform_dockright = this.add.image(
      469,
      -592,
      "structure-platform-dockright",
    );
    ...
    const structure_platform_dock_smallleft = this.add.image(
      648,
      -542,
      "structure-platform-dock-smallleft",
    );
    ...
    const structure_platformleft = this.add.image(
      646,
      -362,
      "structure-platformleft",
    );
    ...
    const structure_platform_dockright_1 = this.add.image(
      474,
      -249,
      "structure-platform-dockright",
    );
    ...
    const tower_complete_largeleft = this.add.image(
      112,
      371,
      "tower-complete-largeleft",
    );
    ...
    const patch_grass_foliageleft_1 = this.add.image(
      1120,
      390,
      "patch-grass-foliageleft",
    );
    ...
    const cargo_container_b_left = this.add.image(
      1123,
      391,
      "cargo-container-b-left",
    );
    cargo_container_b_left.scaleX = 0.15;
    cargo_container_b_left.scaleY = 0.15;

    // ship_pirate_largeleft
    const ship_pirate_largeleft = this.add.image(
      1037,
      262,
      "ship-pirate-largeleft",
    );
    ...
    const tower_complete_smallright = this.add.image(
      152,
      -75,
      "tower-complete-smallright",
    );
    ...
    const cargo_container_c_left = this.add.image(
      700,
      53,
      "cargo-container-c-left",
    );
    cargo_container_c_left.scaleX = 0.1;
    cargo_container_c_left.scaleY = 0.1;

    // palm_detailed_straightright
    const palm_detailed_straightright = this.add.image(
      525,
      489,
      "palm-detailed-straightright",
    );
    ...
    const cargo_container_a_right_1 = this.add.image(
      1125,
      -161,
      "cargo-container-a-right",
    );
    ...
    const tower_complete_smallleft = this.add.image(
      1194,
      -100,
      "tower-complete-smallleft",
    );
    ...
    const cargo_container_b_left_1 = this.add.image(
      887,
      -246,
      "cargo-container-b-left",
    );
    ...
    const cargo_container_a_left = this.add.image(
      383,
      -325,
      "cargo-container-a-left",
    );
    ...
    const ship_pirate_largeleft_1 = this.add.image(
      956,
      -708,
      "ship-pirate-largeleft",
    );
    ...
    const palm_detailed_straightright_1 = this.add.image(
      1071,
      -98,
      "palm-detailed-straightright",
    );
    ...
    const tower_base_doorright = this.add.image(
      1200,
      -526,
      "tower-base-doorright",
    );
    tower_base_doorright.scaleX = 0.15;
    tower_base_doorright.scaleY = 0.15;

    // tower_complete_largeright
    const tower_complete_largeright = this.add.image(
      1203,
      -634,
      "tower-complete-largeright",
    );
  ...
  create() {
    ...
    this.load.bitmapFont("pdark", "assets/fonts/pdark.png", "truetype");
    // welcome
